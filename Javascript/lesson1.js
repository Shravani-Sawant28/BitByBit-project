...
let questions = [
  {
    type: "mcq",
    question: "Q1. What is 'Eight' in German?",
    options: ["null", "neun", "acht", "eins"],
    answer: "acht"
  },
  {
    type: "fill",
    question: "Q2. Fill in the blank: ___ (2) in German",
    answer: "zwei"
  },
  {
    type: "audio",
    question: "Q3. Listen and select the correct word",
    audio: "../Audio/eins.mp3",
    options: ["acht", "eins", "neun", "zwei"],
    answer: "eins"
  },
  {
    type: "match",
  ...
  {
    type: "mcq",
    question: "Q5. What is 'Twenty-Seven' in German?",
    options: ["vierundzwanzig", "siebenundzwanzig", "fünfundzwanzig", "achtundzwanzig"],
    answer: "siebenundzwanzig"
  },
  {
    type: "fill",
    question: "Q6. Fill in the blank: ___ (100) in German",
    answer: "hundert"
  },
  {
    type: "audio",
    question: "Q7. Listen and select the correct word",
    audio: "../Audio/drei.mp3",
    options: ["acht", "drei", "neun", "zwei"],
    answer: "drei"
  },
];
...
let lesson1 = new Audio("../Audio/lesson1.mp3");
